...
/**
 * <p>标题: ImageProcessWithSimpleImageTest 单元测试类 </p>
 * <p>描述: 依赖了 阿里巴巴 simpleimage 图片处理工具类,必须使用Oracle JDK8,不能使用OpenJDK8否则报某类找不到</p>
 ...
 */
public class ImageProcessSIImplTest {
//
...
//        InputStream data = new ImageProcessSIImpl().resize(inputStream, 185, 185, 95, "jpg");
...
//        FileInputStream inputStream = new FileInputStream(path);
//        InputStream data = new ImageProcessSIImpl().resizeAndCut(inputStream, 185, 185, 95, "jpg");
...
//        FileInputStream inputStream = new FileInputStream(path);
//        ImageInfo info = new ImageProcessSIImpl().getImageInfo(inputStream);
...
//        FileInputStream inputStream = new FileInputStream(path);
//        String format = new ImageProcessSIImpl().getFormat(inputStream);
...
//        FileInputStream inputStream = new FileInputStream(path);
//        ImageInfo info = new ImageProcessSIImpl().getImageWH(inputStream);
//        System.out.println(info.toString());
//        TestCase.assertEquals(4000, info.getWidth());
//        TestCase.assertEquals(3000, info.getHeight());
//    }
