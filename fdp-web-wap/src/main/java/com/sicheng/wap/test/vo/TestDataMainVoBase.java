 ...
 * @version 2022-04-12
 */
@ApiModel(value="业务数据表-接收参数的TestDataMainVo类")
public class TestDataMainVoBase implements Serializable {
...
//    private Area area;                      // 归属区域
    ...
    @ApiModelProperty(value="开始 加入日期")
    private Date beginInDate;               // 开始 加入日期
    @ApiModelProperty(value="结束 加入日期")
