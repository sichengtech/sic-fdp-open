...
<body>
   ...
   <div class="men_pho" id="men_pho_id" style="	z-index:10003;display:none"></div>
	<script type="text/javascript">
		...
		function clickBack(){
			window.location.href = "${ctx}/cms/list-${category.id}${fns:getUrlSuffix()}";
	...
	<div class="container" style="padding: 15px 15px 0;">
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="seemore">
					<a class="no_border"  href="${ctx}/cms/index-${site.id}${fns:getUrlSuffix()}" >查看更多</a>
				</div>
				<div class="seemore" style="background: none repeat scroll 0 0 #5BB75B;">
					<a class="no_border" style="color:#FFFFFF;" href="weixin://addfriend/elf8848" onclick="men_pho_cli2()">关注公众账号</a>
				</div>
