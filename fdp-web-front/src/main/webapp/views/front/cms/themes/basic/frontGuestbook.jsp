...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			location="${ctx}/guestbook${fns:getUrlSuffix()}?pageNo="+n+"&pageSize="+s;;
		}
	</script>
</head>
<body>
	<div style="padding:0 0 20px;">
		...
		<h4>我要留言</h4>
		<form:form id="inputForm" action="${ctx}/guestbook${fns:getUrlSuffix()}" method="post" class="form-horizontal">
