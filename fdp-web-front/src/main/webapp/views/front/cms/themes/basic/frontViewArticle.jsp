...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			$.get("${ctxa}/cms/comment.do",{theme: '${site.theme}', 'category.id': '${category.id}',
	     ...
	     <div class="row">
	       <div class="span10">
			...
			<ol><c:forEach items="${relationList}" var="relation">
				<li style="float:left;width:230px;"><a href="${ctx}/cms/view-${relation[0]}-${relation[1]}${fns:getUrlSuffix()}">${fns:abbr(relation[2],30)}</a></li>
			</c:forEach></ol>
	  	  </div>
  	    </div>
  	  </div>
