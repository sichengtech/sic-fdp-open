 ...
 */
package com.sicheng.admin.act.entity;

import com.fasterxml.jackson.annotation.JsonFormat;
import com.fasterxml.jackson.annotation.JsonIgnore;
import com.sicheng.admin.act.utils.Variable;
import com.sicheng.common.persistence.BaseEntity;
import com.sicheng.common.utils.StringUtils;
import com.sicheng.common.utils.TimeUtils;
...
public class Act extends BaseEntity {
	...
	private Long businessId;		// 业务绑定ID
...
//	private Variable taskVars; 	// 流程任务变量
	...
	public void setProcIns(ProcessInstance procIns) {
		...
		if (procIns != null && procIns.getBusinessKey() != null){
			...
			setBusinessId(Long.valueOf(ss[1]));
		}
	}
