 ...
 * @version 2022-04-05
 */
public class TestDataChildBase<T> extends DataEntity<T> {
	...
	private TestDataMain testDataMain = null;		//业务数据表。从test_data_child表看去（多对一或一对一）

	public TestDataChildBase() {
		super();
	}

	public TestDataChildBase(Long id){
		super(id);
	}
