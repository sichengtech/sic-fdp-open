...
<body>
	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			<h4 class="title">文章栏目管理</h4>
			<%@ include file="../include/functionBtn.jsp"%>
			<ul class="nav nav-tabs pull-right">
				<li class="active"><a href="javaScript:;"> <i class="fa fa-home"></i> 文章栏目列表</a></li>
				<shiro:hasPermission name="cms:category:edit">
				<li class=""><a href="${ctxa}/cms/category/form.do" > <i class="fa fa-user"></i> 文章栏目添加</a></li>
				</shiro:hasPermission>
			</ul>
		</header>
				...
				<div class="row" style="margin-bottom:10px;">
					<div class="col-sm-2">
						<div class="btn-group">
							...
							<!-- 新增记录按钮 -->
							<shiro:hasPermission name="cms:category:edit">
							<a class="btn btn-default btn-sm tooltips" title="添加" href="${ctxa}/cms/category/form.do"><i class="fa fa-plus"></i></a>
							</shiro:hasPermission>
						</div>
					</div>
					...
					<table id="treeTable" class="table table-bordered table-condensed">
								...
								<tr id="${tpl.id}" pId="${tpl.parent.id ne '1'?tpl.parent.id:'0'}">
									...
									<td>
										...
										<a type="button" class="btn btn-info btn-sm" href="${ctxa}/cms/category/form.do?parent.id=${tpl.id}">
											<i class="fa fa-level-down"></i> 添加下级栏目
										</a>
										</shiro:hasPermission>
						...
						<shiro:hasPermission name="cms:category:edit">
							<div class="form-group">
								<div class="col-lg-6">
									<button type="submit" class="btn btn-info m-r-5">保存排序</button>
								</div>
							</div>
						</shiro:hasPermission>
					</form>
