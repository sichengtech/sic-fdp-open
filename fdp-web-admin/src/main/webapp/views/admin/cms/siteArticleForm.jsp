...
<html lang="zh-CN">
<head>
<title>${not empty article.id==true?'编辑':'添加'}文章</title>
...
<body>
	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			<h4 class="title">${not empty article.id==true?'编辑':'添加'}文章</h4>
			<%@ include file="../include/functionBtn.jsp"%>
			<ul class="nav nav-tabs pull-right">
				<li class=""><a href="${ctxa}/cms/article.do"> <i class="fa fa-home"></i> 文章列表</a></li>
				<li class="active"><a href="javaScript:;" > <i class="fa fa-user"></i> 文章${not empty article.id==true?'编辑':'添加'}</a></li>
			</ul>
		</header>
		<div class="panel-body">
			...
			<div class="alert alert-info alert-block fade in ${cookie.fdp_operationTips.value=='0'?'point_hidden':''}" id="point">
				<h5>操作提示</h5>
				<ul>
					<li>文章标题、文章栏目、文章排序为必填项，请根据表单提示信息正确输入选择。</li>
				...
				<div class="tab-pane active" id="home-3">
					<form class="cmxform form-horizontal adminex-form" id="inputForm" action="${ctxa}/cms/article/save.do" method="post">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"><font color="red">*</font>归属栏目&nbsp;:</label>
							<div class="col-sm-5">
								...
								title="栏目" url="/cms/category/treeData.do" module="article" selectScopeModule="true" notAllowSelectRoot="false" notAllowSelectParent="true" cssClass="input-sm"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">外部链接&nbsp;:</label>
							<div class="col-sm-5">
								<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<p class="help-block">多个关键字，用逗号分隔。<p>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"> 描述、摘要&nbsp;:</label>
							<div class="col-sm-5">
								<input class="form-control input-sm" type="text" name="description" value="${article.description}">
							</div>
							<div class="col-sm-5">
								<p class="help-block">请填写描述、摘要<p>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"> 缩略图&nbsp;:</label>
							<div class="col-sm-5">
								<input type="hidden" class="existSize_image" value="${not empty article.image?'1':'0'}"/>								<input id="fileUpload_image" name="fileUpload" type="file" thumbnail="100x100" tokenPath="${ctxa}/sys/sysToken/getToken.do" suffix="image" allowType="jpg,jpeg,png,bmp" fileSize="5242880" class="fileUploadClass"/>
								<div class="result_image"></div>
								<div class="uploadImgDiv" id="img_image_0" style="${not empty article.image?'':'display:none;'}">
									<input type="hidden" class="imgPath" name="image" value="${article.image}"/>
									<div class="result"></div>
									<img class="preview" src="${ctxfs}${article.image}@!100x100" style="${not empty article.image?'':'display:none;'}"/>
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"><font color="red">*</font>正文&nbsp;:</label>
							<div class="col-sm-10">
								<div class="controls">
									<!-- 加载编辑器的容器 -->
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">来源&nbsp;:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<p class="help-block">如果栏目不需要审核，则将该内容设为发布状态<p>
							</div>
						</div>
						<%-- <div class="form-group">
