...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctxa}/act/process/deploy.do">部署流程</a></li>
		<li><a href="${ctxa}/act/process/running.do">运行中的流程</a></li>
	</ul><br/>
	<sys:message content="${message}"/>
	<form id="inputForm" action="${ctxa}/act/process/deploy.do" method="post" enctype="multipart/form-data" class="form-horizontal">
