...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctxa}/act/task/form.do?taskId=${act.taskId}&taskName=${act.taskName}&taskDefKey=${act.taskDefKey}&procInsId=${act.procInsId}&procDefId${act.procDefId}">${empty act.procInsId?"新建任务":"任务处理"}</a></li>
	</ul>
