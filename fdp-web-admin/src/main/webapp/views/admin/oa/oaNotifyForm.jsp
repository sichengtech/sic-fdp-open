...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctxa}/oa/oaNotify.do">通知列表</a></li>
		<li class="active"><a href="${ctxa}/oa/oaNotify/form.do?id=${oaNotify.id}">通知<shiro:hasPermission name="oa:oaNotify:edit">${oaNotify.status eq '1' ? '查看' : not empty oaNotify.id ? '修改' : '添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaNotify:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaNotify" action="${ctxa}/oa/oaNotify/save.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>
