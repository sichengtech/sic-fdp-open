...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctxa}/oa/testAudit/form.do?id=${testAudit.id}"><shiro:hasPermission name="oa:testAudit:edit">审批${not empty testAudit.id?'修改':'申请'}流程</shiro:hasPermission><shiro:lacksPermission name="oa:testAudit:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="testAudit" action="${ctxa}/oa/testAudit/save.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>
