	...
	<section class="panel">
		...
		<div class="panel-body">
			...
			<div class="alert alert-info alert-block fade in ${cookie.fdp_operationTips.value=='0'?'point_hidden':''}" id="point">
				<h4>角色名称&nbsp;:&nbsp;${role.name}</h4>
				<p>英文名称:${role.enname}</p>
				<p>角色类型: ${fns:getDictLabel(role.roleType, 'sys_role_type', '')}</p>
				<p>数据范围: ${fns:getDictLabel(role.dataScope, 'sys_data_scope', '无')}</p>
			</div>
			<!--角色信息结束 --> 
			<!-- 分配角色开始 --> 
