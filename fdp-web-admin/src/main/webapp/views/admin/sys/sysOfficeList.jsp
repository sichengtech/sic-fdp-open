	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			...
			<ul class="nav nav-tabs pull-right">
				<li class="active"><a href="javaScript:;"> <i class="fa fa-user"></i> 机构列表</a></li>
				<shiro:hasPermission name="sys:office:edit">
				<li class=""><a href="${ctxa}/sys/office/form.do" > <i class="fa fa-user"></i> 添加机构</a></li>
				</shiro:hasPermission>
			</ul>
		</header>
			...
			<div class="row" style="margin-bottom:10px">
				<div class="col-sm-2">
					<div class="btn-group">
						...
						<shiro:hasPermission name="sys:office:edit">
						<!-- 添加记录按钮 -->
						<a class="btn btn-default btn-sm tooltips" title="添加" href="${ctxa}/sys/office/form.do"><i class="fa fa-plus"></i></a>
						</shiro:hasPermission>
					</div>
				</div>
				...
				<form action="${ctxa}/sys/office/search.do" method="get" >
					<div class="col-sm-2">
						<input type="text" class="form-control input-sm" placeholder="机构名称" name="name" value="${name}" maxlength="20">
					</div>
					<div class="col-sm-2">
