				...
				<div class="tab-pane active" id="home-3">
					<form class="cmxform form-horizontal adminex-form" id="inputForm" action="${ctxa}/sys/user/modifyPwd.do" method="post">
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"><font color="red">*</font> 旧密码&nbsp;:</label>
							<div class="col-sm-5">
								<input class="form-control input-sm" type="password" placeholder="" name="oldPassword"> 
							</div>
							<div class="col-sm-5">
								<p class="help-block">必填项，请填写旧密码<p>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"><font color="red">*</font> 新密码&nbsp;:</label>
							<div class="col-sm-5">
								<input class="form-control input-sm" type="password" placeholder="" id="newPassword" name="newPassword"> 
							</div>
							<div class="col-sm-5">
								<p class="help-block">必填项，请填写新密码<p>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"><font color="red">*</font> 确认新密码&nbsp;:</label>
							<div class="col-sm-5">
								<input class="form-control input-sm" type="password" placeholder="" name="confirmNewPassword"> 
							</div>
							<div class="col-sm-5">
								<p class="help-block">必填项，请确认密码<p>
							</div>
						</div>
						<div class="form-group">
