	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="javaScript:;" > <i class="fa fa-user"></i> 编辑管理员</a></li>
				</shiro:hasPermission>
			</ul>
		</header>
		<!-- panel-body开始 -->
				...
				<div class="tab-pane active" id="home-3">
					<form class="cmxform form-horizontal adminex-form" id="inputForm" action="${ctxa}/sys/user/edit2.do" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<p class="help-block">若不修改密码，请留空。<p>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">确认密码&nbsp;:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
							 <input type="checkbox" ${user.loginFlag eq 0?"":"checked"} data-size="small" style="display: none" value="1" data-on-text="是" data-off-text="否" name="loginFlag" value="66"/>
							</div>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"> 创建时间&nbsp;:</label>
							<div class="col-sm-5">
