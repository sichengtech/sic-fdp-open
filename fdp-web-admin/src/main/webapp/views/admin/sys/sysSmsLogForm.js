$(function(){
	if(jsValidate){
		$("#inputForm").validate({
			...
			messages: {
				"sslId":{required: "必填项",maxlength:"最大长度不能超过19位",},
				"content":{maxlength:"最大长度不能超过255位",},
				"templatecode":{maxlength:"最大长度不能超过128位",},
				"status":{maxlength:"最大长度不能超过1位",},
				"bewrite":{maxlength:"最大长度不能超过128位",},
				"type":{maxlength:"最大长度不能超过1位",},
