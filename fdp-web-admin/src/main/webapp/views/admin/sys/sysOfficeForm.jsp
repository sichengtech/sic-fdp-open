...
<html lang="zh-CN">
<head>
<title>${not empty office.id==true?'编辑':'添加'}机构</title>
...
<body>
	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			<h4 class="title">${not empty office.id==true?'编辑':'添加'}机构</h4>
			<%@ include file="../include/functionBtn.jsp"%>
			<ul class="nav nav-tabs pull-right">
				<li class=""><a href="${ctxa}/sys/office/list.do"> <i class="fa fa-home"></i> 机构列表</a></li>
				<shiro:hasPermission name="sys:office:edit">
				<li class="active"><a href="javaScript:;" > <i class="fa fa-user"></i> 机构${not empty office.id==true?'编辑':'添加'}</a></li>
				</shiro:hasPermission>
			</ul>
		</header>
				...
				<div class="tab-pane active" id="home-3">
					<form class="cmxform form-horizontal adminex-form" id="inputForm" action="${ctxa}/sys/office/save.do" method="post">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">上级机构&nbsp;:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">归属区域&nbsp;:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"><font color="red">*</font>机构名称&nbsp;:</label>
							<div class="col-sm-5">
								<input class="form-control input-sm" type="text" name="name" value="${office.name}"> 
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">机构编码&nbsp;:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">机构类别&nbsp;:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="checkbox" name="useable" ${office.useable eq 0?"":"checked"} data-size="small" value="1" style="display: none" data-on-text="是" data-off-text="否"/>
							</div>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">主负责人&nbsp;:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">副负责人&nbsp;:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">联系地址&nbsp;:</label>
							<div class="col-sm-5">
								<input class="form-control input-sm" type="text" name="address" value="${office.address}"> 
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">邮政编码&nbsp;:</label>
							<div class="col-sm-5">
								<input class="form-control input-sm" type="text" name="zipCode" value="${office.zipCode}"> 
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess">负责人&nbsp;:</label>
							<div class="col-sm-5">
						...
						<div class="form-group" >
							<label class="control-label col-sm-2" for="inputSuccess">传真&nbsp;:</label>
							<div class="col-sm-5">
						...
						<c:if test="${empty office.id}">
							<div class="form-group">
								<label class="control-label col-sm-2" for="inputSuccess"> 快速添加下级部门:&nbsp;:</label>
