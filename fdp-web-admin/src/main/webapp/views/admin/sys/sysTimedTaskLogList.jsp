			...
			<table class="table table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<c:if test="${sysTimedTaskLog.result==0}">失败</c:if>
							<c:if test="${sysTimedTaskLog.result==1}">成功</c:if>
							<c:if test="${sysTimedTaskLog.result==2}">执行中</c:if>
						</td>
