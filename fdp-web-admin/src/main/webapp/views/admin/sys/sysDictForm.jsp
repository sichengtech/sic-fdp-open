...
<html lang="zh-CN">
<head>
<title>${empty dict.id?'添加':'编辑'}字典</title>
...
<body>
	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			<h4 class="title">${empty dict.id?'添加':'编辑'}字典</h4>
			<%@ include file="../include/functionBtn.jsp"%>
			<ul class="nav nav-tabs pull-right">
				<li class=""><a href="${ctxa}/sys/dict.do"> <i class="fa fa-user"></i> 字典管理</a></li>
				<shiro:hasPermission name="sys:dict:edit">
				<li class="active"><a href="javaScript:;"> <i class="fa fa-user"></i> 添加字典</a></li>
				</shiro:hasPermission>
			</ul>
		</header>
		<!-- panel-body开始 -->
				...
				<div class="tab-pane active" id="home-3">
					<form class="cmxform form-horizontal adminex-form" action="${ctxa}/sys/dict/save.do" id="inputForm" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<p class="help-block">必填项，字典的值，同一类型内不可重复<p>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<p class="help-block">必填项，字典的显示名称<p>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<p class="help-block">必填项，按类型对字典进行分类，按类型查找字典<p>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<p class="help-block">可空，也可作为第三个值<p>
							</div>
						</div>
						<div class="form-group">
