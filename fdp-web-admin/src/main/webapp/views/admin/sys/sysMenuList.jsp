...
<body>
	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right">
			<h4 class="title">菜单列表管理 </h4>
			<%@ include file="../include/functionBtn.jsp"%>
			<ul class="nav nav-tabs pull-right">
				<li class="active"><a href="javascript:;" data-toggle="tab"> <i class="fa fa-home"></i> 菜单列表</a></li>
				<shiro:hasPermission name="sys:menu:edit">
				<li class=""><a href="${ctxa}/sys/menu/form.do" > <i class="fa fa-user"></i> 添加菜单</a></li>
				</shiro:hasPermission>
			</ul>
		</header>
		<!-- panel-body开始 -->
		<div class="panel-body">
			...
			<div class="alert alert-info alert-block fade in ${cookie.fdp_operationTips.value=='0'?'point_hidden':''}" id="point">
				<h5>操作提示</h5>
				<ul>
					<li>点击"添加下级菜单"可以给当前的菜单添加下级菜单。</li>
				</ul>
			</div>
			<!-- 提示结束 --> 
			<!-- 按钮开始 -->
			<div class="row" style="margin-bottom:10px;">
				<div class="col-sm-2">
					<div class="btn-group">
						...
						<shiro:hasPermission name="sys:menu:edit">
						<!-- 新增记录按钮 -->
						<a class="btn btn-default btn-sm tooltips" title="添加" href="${ctxa}/sys/menu/form.do"><i class="fa fa-plus"></i></a>
						</shiro:hasPermission>
					</div>
				</div>
				...
				<form action="${ctxa}/sys/menu/search.do" method="get" >
					<div class="col-sm-2">
						<input type="text" class="form-control input-sm" placeholder="菜单名称" maxLength="64" name="name" value="${name}">
					</div>
...
<%--								<td>${menu.menuNum}</td>--%>
								...
								<td nowrap>
									...
									<a type="button" class="btn btn-info btn-sm" href="${ctxa}/sys/menu/form.do?parent.id=${menu.id}">
										<i class="fa fa-level-down"></i> 添加下级菜单
									</a>
									</shiro:hasPermission>
