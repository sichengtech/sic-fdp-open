...
<body>
	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			<h4 class="title">系统变量列表</h4>
			<%@ include file="../include/functionBtn.jsp"%>
			<ul class="nav nav-tabs pull-right">
				<li class="active"><a href="javaScript:;"> <i class="fa fa-user"></i> 系统变量列表</a></li>
				<shiro:hasPermission name="sys:sysVariable:save"><li class=""><a href="${ctxa}/sys/sysVariable/save1.do" > <i class="fa fa-user"></i> 系统变量添加</a></li></shiro:hasPermission>
			</ul>
		</header>
			...
			<div class="row" style="margin-bottom:10px">
				<div class="col-sm-2">
					<div class="btn-group">
						...
						<a class="btn btn-default btn-sm tooltips" title="添加" href="${ctxa}/sys/sysVariable/save1.do"><i class="fa fa-plus"></i></a>
						</shiro:hasPermission>
					</div>
				</div>
				<form action="${ctxa}/sys/sysVariable/list.do" method="get" id="searchForm">
					...
					<div class="col-sm-2">
						<input type="text" name="name"  maxlength="64" class="form-control input-sm" placeholder="变量名" value="${sysVariable.name}"/>
					</div>
			...
			<table class="table table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>${empty sysVariable.value?'无':sysVariable.value}</td>
