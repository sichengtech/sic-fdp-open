...
<html lang="zh-CN">
<head>
<title>${empty menu.id?'添加':'编辑'}菜单</title>
...
<body>
	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			<h4 class="title">${empty menu.id?'添加':'编辑'}菜单</h4>
			<%@ include file="../include/functionBtn.jsp"%>
			<ul class="nav nav-tabs pull-right">
				<li class=""><a href="${ctxa}/sys/menu.do"> <i class="fa fa-home"></i> 菜单列表</a></li>
				<shiro:hasPermission name="sys:menu:edit">
				<li class="active"><a href="javascript:;" > <i class="fa fa-user"></i> ${empty menu.id?'添加':'编辑'}菜单</a></li>
				</shiro:hasPermission>
			</ul>
		</header>
		<!-- panel-body开始 -->
		<div class="panel-body">
			...
			<div class="alert alert-info alert-block fade in ${cookie.fdp_operationTips.value=='0'?'point_hidden':''}" id="point">
				<h5>操作提示</h5>
				<ul>
					<li>"上级菜单"可以随意进行选择。名称、编号和排序是必填项。</li>
				</ul>
			</div>
			<!-- 提示结束 -->	
...
<%--						</div>--%>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
							 	<input type="checkbox" ${menu.isShow eq 0?"":"checked"} data-size="small" value="1" style="display: none" data-on-text="显示" data-off-text="隐藏" name="isShow" id="isShow"/>
							</div>
							<div class="col-sm-5">
