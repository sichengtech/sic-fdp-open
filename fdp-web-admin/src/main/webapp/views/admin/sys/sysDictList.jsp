...
<body>
	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			<h4 class="title">数据字典</h4>
			<%@ include file="../include/functionBtn.jsp"%>
			<ul class="nav nav-tabs pull-right">
				<li class="active"><a href="javascript:;"> <i class="fa fa-user"></i> 字典管理</a></li>
				<shiro:hasPermission name="sys:dict:edit">
				<li class=""><a href="${ctxa}/sys/dict/form.do"> <i class="fa fa-user"></i> 添加字典</a></li>
				</shiro:hasPermission>
			</ul>
		</header>
		<!-- panel-body开始 -->
			...
			<div class="row" style="margin-bottom:10px;">
				<div class="col-sm-2">
					<div class="btn-group">
						...
						<shiro:hasPermission name="sys:dict:edit">
						<!-- 新增记录按钮 -->
						<a class="btn btn-default btn-sm tooltips" title="添加" href="${ctxa}/sys/dict/form.do"><i class="fa fa-plus"></i></a>
						</shiro:hasPermission>
					</div>
				</div>
					...
					<div class="col-sm-3">
						<select class="selectpicker form-control input-sm" name="type" id="type" style="padding: 5px 4px;"> 
							...
							<c:forEach items="${typeList}" var="type">
						 		<option value="${type}" ${dictType eq type?"selected":""}>${type}</option>
							</c:forEach>
						</select>
					</div>
