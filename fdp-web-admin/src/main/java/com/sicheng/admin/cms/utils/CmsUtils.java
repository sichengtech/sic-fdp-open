...
//	}
	...
	public static String getUrlDynamic(Article article) {
		...
		sbl.append(context.getContextPath()).append(Global.getFrontPath());
		sbl.append("/cms");
		sbl.append("/view-").append(article.getCategory().getId()).append("-").append(article.getId()).append(Global.getUrlSuffix());
		return sbl.toString();
	}
