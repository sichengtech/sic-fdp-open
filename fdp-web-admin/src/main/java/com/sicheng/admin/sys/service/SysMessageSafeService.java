...
//					//查询网站名称
//					SiteInfo siteInfo = null;//siteInfoService.selectOne(new Wrapper());
//					String name = "shop商城";
//					if(siteInfo!=null){
...
//					}
//					List<UserMain> userMainList = null;//userMainService.selectByIdIn(uIdsList);
...
//									emailSender.send(name, userMainList.get(i).getEmail(), name+":网站通知", message, true);
